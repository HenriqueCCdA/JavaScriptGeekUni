...
class Pessoa {
    ...
    set nome_completo(nome_completo){
        ...
        // junta os elementos do array em um string separando cada elemento por espaço
...
const c2 = new Cliente('Angelina', 'Jolie', 'angelina@gmail.com', '123.456.789.11', 8974.34);
...
c1.nome_completo = 'Xuxa Menneguel';
console.log(c1);
...
const f2 = new Funcionario('Maria', 'Siqueira', 'maria@gmail.com', '345.322.987.35', programador, 'Fidu09');
