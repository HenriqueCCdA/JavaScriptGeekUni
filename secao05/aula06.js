...
Primeira execução:
    - Pega os dois primeiros valores (índice 0 e índece 1), soma e retorna este valor;
Nas demias execuções:
    - Pega o returno da execução anterior e próximo valor (índice 2...)
