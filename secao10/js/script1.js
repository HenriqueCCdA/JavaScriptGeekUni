...
btn.onclick = function(){
    ...
    ajax.onreadystatechange = function(){
        ...
        /*
            ...
            ajax.readyState -> 3 => Carregando o corpo da requisição (condeúdo/dados)
        ...
        */
        ...
        if(ajax.readyState === 4){
            if(ajax.status === 200){
                ...
                txtNome = document.createTextNode(`Não encontrei o usario ${input.value}`);
