...
class App{
    ...
    constructor(){
        ...
        // Lista
        this.lista = document.querySelector('.lista-group');

        // Método para registrat os eventos do form
    ...
    apresentarBuscando(){
        ...
        let txtBuscando = document.createTextNode('Aguerde, buscando o repositório.');
